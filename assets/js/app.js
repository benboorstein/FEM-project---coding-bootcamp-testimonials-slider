...
// FYI: The way the below is written means this app would work even if there were, say, 20 objects in the testimonials array instead of just 3.
let counter = 0 // *** the key to understanding how this program works is remembering that 'counter' (here in the global scope) gets updated each/every time 'counter' gets updated in the 'getTestimonial()' function! ***
